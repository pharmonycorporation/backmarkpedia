...
import { InboxManagerComponent } from './email/inbox/inbox.component';
import { ComposeManagerComponent } from './email/compose/compose.component';
import { OutputManagerComponent } from './email/send/output.component';
import { ReadManagerComponent } from './email/read/read.component';
import { NewsletterComponent } from './newsletter/newsletter.comopent';
import { AddSupplierComponent } from './add-suppliers/add-supplier.component';
                ...
                {path: 'login', component: LoginComponent},
				{
                    path: 'admin', component: AdminComponent, children: [
                      ...
                      { path: 'support', loadChildren: () => import('./support/support.module').then(m => m.SupportModule), data: { breadcrumb: 'reviews' } },
                        ...
                        {path: 'suppliers', component: PrestatairesComponent },
                        ...
                        {path: 'email', component: InboxManagerComponent},
                        {path: 'email/send', component: ComposeManagerComponent},
                        {path: 'email/envoi', component: OutputManagerComponent},
                        {path: 'email/reply/:id', component: ComposeManagerComponent},
                        {path: 'email/smail', component: ComposeManagerComponent},
                        {path: 'email-read', component: ReadManagerComponent},
                        {path: 'email/newsletter', component: NewsletterComponent},
                        {path: 'email-read/:id', component: ReadManagerComponent},
                        {path: 'email-read/:message_id/:message', component: ReadManagerComponent},
