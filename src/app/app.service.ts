...
export class AppService {
    ...
    public host: string = "https://markpedia.herokuapp.com/api/";
    ...
    public getProductById(id): Observable<any>{
        return this.http.get<any>("https://markpedia.herokuapp.com/api/marketplaceproducts/"+id+"/");
    }
    ...
    public getDeliveryMethods(){
        return [
            { value: 'Air', name: 'Express Delivery (Plane)', desc: '$10.00/Kg -/ Delivery in 3 to 7 business Days' },
            { value: 'Boat', name: 'Standard Delivery (Boat)', desc: '$5.99/Kg -/ Delivery in 30 to 45 business Days' },
